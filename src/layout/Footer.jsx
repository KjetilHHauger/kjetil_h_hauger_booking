    ...
    <footer className="bg-brand-primary text-font-primary">
      <section className="flex flex-col px-10 md:flex-row mx-auto">
        ...
        <section className="flex-1 flex flex-col py-10 gap-2">
          ...
          <a href="https://hudd.no" aria-label="Hudd">
            <svg
          ...
          <a href="https://bsky.app" aria-label="BlueSky">
            <svg fill="none" viewBox="0 0 64 57" className="w-8 h-8 ml-1">
              <path
                fill="currentColor"
          ...
          <a href="https://www.tumblr.com" aria-label="Tumblr">
            <TumblrLogo size={32} weight="fill" />
          </a>
        </section>
      </section>
    </footer>
