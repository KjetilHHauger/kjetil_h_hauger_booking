  ...
  return (
    <div className="max-w-4xl mx-auto p-6 flex flex-col md:flex-row gap-8">
      <div className="md:w-1/3 text-center md:text-left text-brand-primary">
        ...
        />
        <h2 className="mt-4 text-heading-4 font-bold truncate">{user.name}</h2>
        <p className="text-body-md text-gray-600 break-all">{user.email}</p>
        <p className="mt-2 text-body-sm text-gray-700 whitespace-pre-wrap truncate md:max-w-[250px]">
